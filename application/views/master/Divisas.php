			...
			<form class="mt-3">
				...
				<div class="row">
					<div class="col-auto">
						...
						<input id="compra-eur" type="number" step="0.01" name="compra-eur" placeholder="Compra" autocomplete="off">
					</div>
					<div class="col-auto">
						<label> EUR Venta:</label>
						<input id="venta-eur" type="number" step="0.01" name="venta-eur" placeholder="Venta" autocomplete="off">
					</div>
					<div class="col-auto">
						<button id="submit-eur" class="btn">Actualizar</button>
					</div>
				</div>
			</form>
		</div>
